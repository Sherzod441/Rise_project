      ...
      <div class="contact-img">
        <div class="container">
          <div class="row">
            <div class="col-md-4">
              <div class="about-us">
                <h1 class="text-white mt-5">Bog‘lanish</h1>
              </div>
            </div>
            ...
            <div class="col-md-4">
              <div class="about-text">
                <p class="text-white">
                  Biz bilan bog‘lanish mumkin bo‘lgan barcha ma’lumotlarni shu
                  bo‘limdan olishingiz mumkin
                </p>
              </div>
            </div>
          </div>
        ...
        <div class="container">
          <div class="row">
            <div class="col-md-4">
              <div class="card card-body p-4 border-0">
                <div class="card-title border-bottom p-3">
                  <img class="me-4" src="../assets/Frames/Frame.png" alt="" />
                  Telefon raqam
                </div>
                <div class="card-subtitle pt-3 ps-3">
                  <p>+998(97)-221-3636</p>
                  <p>+998(97)-221-3636</p>
                </div>
              </div>
            ...
            <div class="col-md-4">
              <div class="card card-body p-4 border-0">
                <div class="card-title border-bottom p-3">
                  <img class="me-4" src="../assets/Frames/Frame1.png" alt="" />
                  Email pochta
                </div>
                <div class="card-subtitle pt-3 ps-3">
                  <p>+998(97)-221-3636</p>
            ...
            <div class="col-md-4">
              <div class="card card-body p-4 border-0">
                <div class="card-title border-bottom p-3">
                  <img class="me-4" src="../assets/Frames/Frame2.png" alt="" />
                  Manzil
                </div>
                <div class="card-subtitle pt-3 ps-3">
                  <p>+998(97)-221-3636</p>
    ...
    <section id="location" class="mb-4">
      <div class="container">
        <div class="row">
          <div class="col-md-12">
            <img
              class="location img-fluid w-100"
